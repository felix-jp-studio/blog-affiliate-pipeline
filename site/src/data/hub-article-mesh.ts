...
export const hubArticleMesh: Partial<Record<CategorySlug, HubArticleMesh>> = {
  sim: {
    ...
    featured: [
      ...
      {
        slug: "mineo-kaiyaku-tejun",
        label: "mineo 解約手順",
      },
      {
        slug: "rakuten-mobile-esim-settei-tejun",
        label: "楽天モバイル eSIM 設定",
      },
      {
  ...
  cost: {
    ...
    featured: [
      ...
      {
        slug: "hikkoshi-hikari-denki-set",
        label: "引越し 光回線 電気 セットで固定費を見直す",
      },
      {
        slug: "softbank-denki",
        label: "ソフトバンク でんきで固定費を見直す",
      },
      {
        slug: "hikari-denki-setwari",
        label: "光回線 電気 セット割で固定費を見直す",
      },
    ],
  },
};
