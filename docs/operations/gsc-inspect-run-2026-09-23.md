...
| indexed        | 161                             |
| 今回バッチ     | 10 / 21                         |
| 生成日時 (UTC) | 2026-09-23T02:05:50.095Z        |

## 結果

|   # | slug                              | UI       | API verdict | indexed | 備考 |
| --: | --------------------------------- | -------- | ----------- | :-----: | ---- |
|   1 | mnp-yoyaku-bangou-error-fix       | api-only | NEUTRAL     |   ⏳    |      |
|   2 | sim-gakusei-20gb-hikaku           | api-only | NEUTRAL     |   ⏳    |      |
|   3 | povo-2-0-tsukaikata               | api-only | NEUTRAL     |   ⏳    |      |
|   4 | kodomo-sim-family-hikaku          | api-only | NEUTRAL     |   ⏳    |      |
|   5 | rakuten-mobile-esim-settei-houhou | api-only | PASS        |   ✅    |      |
